...
def open_resource(name):
	...
	# from http://takashi-matsuo.blogspot.com/2008/07/using-newest-zipped-pytz-on-gae.html
	# or see http://appengine-cookbook.appspot.com/recipe/caching-pytz-helper/
	for part in name_parts:
   		if part == os.path.pardir or os.path.sep in part:
   			raise ValueError('Bad path segment: %r' % part)
